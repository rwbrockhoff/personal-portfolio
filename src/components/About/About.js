  ...
  render() {
    return (
      <section className="about-section">
        ...
        <p>I'm a web developer with an emphasis on frontend and design. Previously, I was an elopement photographer + videographer with my fiance. When I wasn't standing on cliff edges in Yosemite or Moab, I was passionately coding and learning new things. I'm constantly challenging myself to improve as a developer and a designer. I'm at my happiest when I'm building useful and intuitive software.</p>
        <a href="https://github.com/rwbrockhoff/personal-portfolio" target="_blank" rel="noopener noreferrer">
